        ...
        <table className="w-full">
          ...
          <tbody>
            {data?.map((item, index) => (
              <tr
                key={index}
                className="text-smtext-gray-600 border-b border-gray-200 dark:border-gray-700"
              >
                <td className="py-4">
                ...
                <td className="px-2 py-3">
                  <div className="flex flex-col">
                    <p className="text-base font-medium text-black 2x1:text-lg dark:text-gray-400 line-clamp-1">
                      {item?.description}
                    </p>
                  </div>
                </td>
                ...
                <td
                  className="flex items-center px-2 py-4 font-medium text-black
